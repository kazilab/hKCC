...
from db.config import APP_CONTACT_EMAIL, APP_VERSION
...
def search_works(
    ...
    *,
    ...
    r = httpx.get(url, timeout=30.0, headers={"User-Agent": f"hKCC/{APP_VERSION} (mailto:{mailto})"})
    r.raise_for_status()
    data = r.json()
