...
from hkcc.db.config import APP_CONTACT_EMAIL
from hkcc.pipelines.clients import ccte, openalex, pubchem
...
def render_live_feeds(*, show_header: bool = True) -> None:
    if show_header:
        ...
        st.caption(
            "On-demand calls to public APIs. hKCC scores remain in the database; "
